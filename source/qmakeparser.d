...
struct GenericQMakeProject(TParseTree)
{
    ...
    static this()
    {
        ...
        rules["CustomFunctionId"] = toDelegate(&CustomFunctionId);
        rules["FunctionId"] = toDelegate(&FunctionId);
        rules["FunctionIdImpl"] = toDelegate(&FunctionIdImpl);
        rules["FunctionIdAtom"] = toDelegate(&FunctionIdAtom);
        rules["PureFunctionIdentifier"] = toDelegate(&PureFunctionIdentifier);
        rules["ExpandedFunctionIdentifier"] = toDelegate(&ExpandedFunctionIdentifier);
        rules["FunctionArgumentStopRule"] = toDelegate(&FunctionArgumentStopRule);
        ...
        rules["ErrorMessage"] = toDelegate(&ErrorMessage);
    ...
    static TParseTree Statement(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.longest_match!(FunctionDeclaration, Assignment, ForStatement, Scope, Block, ReplaceFunctionCall, TestFunctionCall, BooleanExpression, Comment, pegged.peg.discard!(EmptyStatement)), "QMakeProject.Statement")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.longest_match!(FunctionDeclaration, Assignment, ForStatement, Scope, Block, ReplaceFunctionCall, TestFunctionCall, BooleanExpression, Comment, pegged.peg.discard!(EmptyStatement)), "QMakeProject.Statement"), "Statement")(p);
    ...
    static TParseTree Statement(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.longest_match!(FunctionDeclaration, Assignment, ForStatement, Scope, Block, ReplaceFunctionCall, TestFunctionCall, BooleanExpression, Comment, pegged.peg.discard!(EmptyStatement)), "QMakeProject.Statement")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.longest_match!(FunctionDeclaration, Assignment, ForStatement, Scope, Block, ReplaceFunctionCall, TestFunctionCall, BooleanExpression, Comment, pegged.peg.discard!(EmptyStatement)), "QMakeProject.Statement"), "Statement")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree CustomFunctionId(TParseTree p)
    {
        if(__ctfe)
        {
        ...
        {
            if (auto m = tuple(`CustomFunctionId`, p.end) in memo)
                return *m;
            else
            {
    ...
    static TParseTree CustomFunctionId(string s)
    {
        if(__ctfe)
        {
    ...
    {
        return "QMakeProject.CustomFunctionId";
    }
    ...
    static TParseTree FunctionId(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.negLookahead!(CustomFunctionId), FunctionIdImpl), "QMakeProject.FunctionId")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.negLookahead!(CustomFunctionId), FunctionIdImpl), "QMakeProject.FunctionId"), "FunctionId")(p);
    ...
    static TParseTree FunctionId(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.negLookahead!(CustomFunctionId), FunctionIdImpl), "QMakeProject.FunctionId")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.negLookahead!(CustomFunctionId), FunctionIdImpl), "QMakeProject.FunctionId"), "FunctionId")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree FunctionIdImpl(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(FunctionIdAtom, pegged.peg.zeroOrMore!(FunctionIdAtom)), "QMakeProject.FunctionIdImpl")(p);
        }
        else
        {
            if (auto m = tuple(`FunctionIdImpl`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(FunctionIdAtom, pegged.peg.zeroOrMore!(FunctionIdAtom)), "QMakeProject.FunctionIdImpl"), "FunctionIdImpl")(p);
                memo[tuple(`FunctionIdImpl`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree FunctionIdImpl(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(FunctionIdAtom, pegged.peg.zeroOrMore!(FunctionIdAtom)), "QMakeProject.FunctionIdImpl")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(FunctionIdAtom, pegged.peg.zeroOrMore!(FunctionIdAtom)), "QMakeProject.FunctionIdImpl"), "FunctionIdImpl")(TParseTree("", false,[], s));
        }
    }
    static string FunctionIdImpl(GetName g)
    {
        return "QMakeProject.FunctionIdImpl";
    }

    static TParseTree FunctionIdAtom(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(PureFunctionIdentifier, ExpandedFunctionIdentifier), "QMakeProject.FunctionIdAtom")(p);
        }
        else
        {
            if (auto m = tuple(`FunctionIdAtom`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(PureFunctionIdentifier, ExpandedFunctionIdentifier), "QMakeProject.FunctionIdAtom"), "FunctionIdAtom")(p);
                memo[tuple(`FunctionIdAtom`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree FunctionIdAtom(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(PureFunctionIdentifier, ExpandedFunctionIdentifier), "QMakeProject.FunctionIdAtom")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(PureFunctionIdentifier, ExpandedFunctionIdentifier), "QMakeProject.FunctionIdAtom"), "FunctionIdAtom")(TParseTree("", false,[], s));
        }
    }
    static string FunctionIdAtom(GetName g)
    {
        return "QMakeProject.FunctionIdAtom";
    }

    static TParseTree PureFunctionIdentifier(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(Identifier, pegged.peg.and!(pegged.peg.literal!("{"), Identifier, pegged.peg.literal!("}")), pegged.peg.and!(doublequote, Identifier, doublequote)), "QMakeProject.PureFunctionIdentifier")(p);
        }
        else
        {
            if (auto m = tuple(`PureFunctionIdentifier`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(Identifier, pegged.peg.and!(pegged.peg.literal!("{"), Identifier, pegged.peg.literal!("}")), pegged.peg.and!(doublequote, Identifier, doublequote)), "QMakeProject.PureFunctionIdentifier"), "PureFunctionIdentifier")(p);
                memo[tuple(`PureFunctionIdentifier`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PureFunctionIdentifier(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(Identifier, pegged.peg.and!(pegged.peg.literal!("{"), Identifier, pegged.peg.literal!("}")), pegged.peg.and!(doublequote, Identifier, doublequote)), "QMakeProject.PureFunctionIdentifier")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(Identifier, pegged.peg.and!(pegged.peg.literal!("{"), Identifier, pegged.peg.literal!("}")), pegged.peg.and!(doublequote, Identifier, doublequote)), "QMakeProject.PureFunctionIdentifier"), "PureFunctionIdentifier")(TParseTree("", false,[], s));
        }
    }
    static string PureFunctionIdentifier(GetName g)
    {
        return "QMakeProject.PureFunctionIdentifier";
    }

    static TParseTree ExpandedFunctionIdentifier(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(ExpandStatement, pegged.peg.and!(doublequote, ExpandStatement, doublequote)), "QMakeProject.ExpandedFunctionIdentifier")(p);
        }
        else
        {
            if (auto m = tuple(`ExpandedFunctionIdentifier`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(ExpandStatement, pegged.peg.and!(doublequote, ExpandStatement, doublequote)), "QMakeProject.ExpandedFunctionIdentifier"), "ExpandedFunctionIdentifier")(p);
                memo[tuple(`ExpandedFunctionIdentifier`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree ExpandedFunctionIdentifier(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(ExpandStatement, pegged.peg.and!(doublequote, ExpandStatement, doublequote)), "QMakeProject.ExpandedFunctionIdentifier")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(ExpandStatement, pegged.peg.and!(doublequote, ExpandStatement, doublequote)), "QMakeProject.ExpandedFunctionIdentifier"), "ExpandedFunctionIdentifier")(TParseTree("", false,[], s));
        }
    }
    static string ExpandedFunctionIdentifier(GetName g)
    {
        return "QMakeProject.ExpandedFunctionIdentifier";
    }

    static TParseTree FunctionArgumentStopRule(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(space, COMMA), "QMakeProject.FunctionArgumentStopRule")(p);
        }
        else
        {
            if (auto m = tuple(`FunctionArgumentStopRule`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(space, COMMA), "QMakeProject.FunctionArgumentStopRule"), "FunctionArgumentStopRule")(p);
                memo[tuple(`FunctionArgumentStopRule`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree FunctionArgumentStopRule(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(space, COMMA), "QMakeProject.FunctionArgumentStopRule")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(space, COMMA), "QMakeProject.FunctionArgumentStopRule"), "FunctionArgumentStopRule")(TParseTree("", false,[], s));
        }
    }
    static string FunctionArgumentStopRule(GetName g)
    {
        return "QMakeProject.FunctionArgumentStopRule";
    }
    ...
    static TParseTree List(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(FunctionArgument!(FunctionArgumentStopRule), pegged.peg.oneOrMore!(pegged.peg.and!(delimRule, pegged.peg.option!(FunctionArgument!(delimChar))))), "QMakeProject.List!(" ~ pegged.peg.getName!(delimRule)() ~ ", " ~ pegged.peg.getName!(delimChar) ~ ")")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(FunctionArgument!(FunctionArgumentStopRule), pegged.peg.oneOrMore!(pegged.peg.and!(delimRule, pegged.peg.option!(FunctionArgument!(delimChar))))), "QMakeProject.List!(" ~ pegged.peg.getName!(delimRule)() ~ ", " ~ pegged.peg.getName!(delimChar) ~ ")"), "List_2")(p);
    ...
    static TParseTree List(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(FunctionArgument!(FunctionArgumentStopRule), pegged.peg.oneOrMore!(pegged.peg.and!(delimRule, pegged.peg.option!(FunctionArgument!(delimChar))))), "QMakeProject.List!(" ~ pegged.peg.getName!(delimRule)() ~ ", " ~ pegged.peg.getName!(delimChar) ~ ")")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(FunctionArgument!(FunctionArgumentStopRule), pegged.peg.oneOrMore!(pegged.peg.and!(delimRule, pegged.peg.option!(FunctionArgument!(delimChar))))), "QMakeProject.List!(" ~ pegged.peg.getName!(delimRule)() ~ ", " ~ pegged.peg.getName!(delimChar) ~ ")"), "List_2")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree FunctionArgumentStringStopChar(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.discard!(pegged.peg.or!(delim, LineTerminator, ExpandStatement, quote, doublequote, BACKSLASH, EndOfFunction)), "QMakeProject.FunctionArgumentStringStopChar!(" ~ pegged.peg.getName!(delim) ~ ")")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.discard!(pegged.peg.or!(delim, LineTerminator, ExpandStatement, quote, doublequote, BACKSLASH, EndOfFunction)), "QMakeProject.FunctionArgumentStringStopChar!(" ~ pegged.peg.getName!(delim) ~ ")"), "FunctionArgumentStringStopChar_1")(p);
    ...
    static TParseTree FunctionArgumentStringStopChar(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.discard!(pegged.peg.or!(delim, LineTerminator, ExpandStatement, quote, doublequote, BACKSLASH, EndOfFunction)), "QMakeProject.FunctionArgumentStringStopChar!(" ~ pegged.peg.getName!(delim) ~ ")")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.discard!(pegged.peg.or!(delim, LineTerminator, ExpandStatement, quote, doublequote, BACKSLASH, EndOfFunction)), "QMakeProject.FunctionArgumentStringStopChar!(" ~ pegged.peg.getName!(delim) ~ ")"), "FunctionArgumentStringStopChar_1")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree ScopeElseBranch(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("else"), Block), "QMakeProject.ScopeElseBranch")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("else"), Block), "QMakeProject.ScopeElseBranch"), "ScopeElseBranch")(p);
    ...
    static TParseTree ScopeElseBranch(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("else"), Block), "QMakeProject.ScopeElseBranch")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("else"), Block), "QMakeProject.ScopeElseBranch"), "ScopeElseBranch")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree BooleanAtom(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(ReplaceFunctionCall, pegged.peg.and!(pegged.peg.negLookahead!(ReplaceFunctionCall), ExpandStatement), TestFunctionCall, QualifiedIdentifier, BooleanConst), "QMakeProject.BooleanAtom")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(ReplaceFunctionCall, pegged.peg.and!(pegged.peg.negLookahead!(ReplaceFunctionCall), ExpandStatement), TestFunctionCall, QualifiedIdentifier, BooleanConst), "QMakeProject.BooleanAtom"), "BooleanAtom")(p);
    ...
    static TParseTree BooleanAtom(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(ReplaceFunctionCall, pegged.peg.and!(pegged.peg.negLookahead!(ReplaceFunctionCall), ExpandStatement), TestFunctionCall, QualifiedIdentifier, BooleanConst), "QMakeProject.BooleanAtom")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(ReplaceFunctionCall, pegged.peg.and!(pegged.peg.negLookahead!(ReplaceFunctionCall), ExpandStatement), TestFunctionCall, QualifiedIdentifier, BooleanConst), "QMakeProject.BooleanAtom"), "BooleanAtom")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree ForIterableList(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(List!(pegged.peg.discard!(pegged.peg.oneOrMore!(space)), pegged.peg.discard!(space)), FunctionArgument!(FunctionArgumentStopRule)), "QMakeProject.ForIterableList")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(List!(pegged.peg.discard!(pegged.peg.oneOrMore!(space)), pegged.peg.discard!(space)), FunctionArgument!(FunctionArgumentStopRule)), "QMakeProject.ForIterableList"), "ForIterableList")(p);
    ...
    static TParseTree ForIterableList(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(List!(pegged.peg.discard!(pegged.peg.oneOrMore!(space)), pegged.peg.discard!(space)), FunctionArgument!(FunctionArgumentStopRule)), "QMakeProject.ForIterableList")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(List!(pegged.peg.discard!(pegged.peg.oneOrMore!(space)), pegged.peg.discard!(space)), FunctionArgument!(FunctionArgumentStopRule)), "QMakeProject.ForIterableList"), "ForIterableList")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree EvalArg(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(FunctionDeclaration, FunctionArgumentList), "QMakeProject.EvalArg")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.or!(FunctionDeclaration, FunctionArgumentList), "QMakeProject.EvalArg"), "EvalArg")(p);
    ...
    static TParseTree EvalArg(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.or!(FunctionDeclaration, FunctionArgumentList), "QMakeProject.EvalArg")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.or!(FunctionDeclaration, FunctionArgumentList), "QMakeProject.EvalArg"), "EvalArg")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree CacheTestFunctionCallParams(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.option!(QualifiedIdentifier), pegged.peg.option!(pegged.peg.and!(COMMA_WS, CacheTestFunctionParam2)), pegged.peg.option!(pegged.peg.and!(COMMA_WS, FunctionArgument!(FunctionArgumentStopRule)))), "QMakeProject.CacheTestFunctionCallParams")(p);
        }
        else
        {
    ...
    static TParseTree CacheTestFunctionCallParams(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.option!(QualifiedIdentifier), pegged.peg.option!(pegged.peg.and!(COMMA_WS, CacheTestFunctionParam2)), pegged.peg.option!(pegged.peg.and!(COMMA_WS, FunctionArgument!(FunctionArgumentStopRule)))), "QMakeProject.CacheTestFunctionCallParams")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
    ...
    static TParseTree BreakFunctionCall(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("break"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.BreakFunctionCall")(p);
        }
        else
        {
            if (auto m = tuple(`BreakFunctionCall`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("break"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.BreakFunctionCall"), "BreakFunctionCall")(p);
                memo[tuple(`BreakFunctionCall`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree BreakFunctionCall(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("break"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.BreakFunctionCall")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("break"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.BreakFunctionCall"), "BreakFunctionCall")(TParseTree("", false,[], s));
        }
    }
    static string BreakFunctionCall(GetName g)
    {
        return "QMakeProject.BreakFunctionCall";
    }

    static TParseTree NextFunctionCall(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("next"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.NextFunctionCall")(p);
        }
        else
        {
            if (auto m = tuple(`NextFunctionCall`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("next"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.NextFunctionCall"), "NextFunctionCall")(p);
                memo[tuple(`NextFunctionCall`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree NextFunctionCall(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("next"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.NextFunctionCall")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("next"), OPEN_PAR_WS, CLOSE_PAR_WS), "QMakeProject.NextFunctionCall"), "NextFunctionCall")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree ErrorFunctionCall(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("error"), OPEN_PAR_WS, pegged.peg.option!(ErrorMessage), CLOSE_PAR_WS), "QMakeProject.ErrorFunctionCall")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("error"), OPEN_PAR_WS, pegged.peg.option!(ErrorMessage), CLOSE_PAR_WS), "QMakeProject.ErrorFunctionCall"), "ErrorFunctionCall")(p);
    ...
    static TParseTree ErrorFunctionCall(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("error"), OPEN_PAR_WS, pegged.peg.option!(ErrorMessage), CLOSE_PAR_WS), "QMakeProject.ErrorFunctionCall")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.literal!("error"), OPEN_PAR_WS, pegged.peg.option!(ErrorMessage), CLOSE_PAR_WS), "QMakeProject.ErrorFunctionCall"), "ErrorFunctionCall")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree ErrorMessage(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(FunctionArgumentList, "QMakeProject.ErrorMessage")(p);
        }
        else
        {
            if (auto m = tuple(`ErrorMessage`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(FunctionArgumentList, "QMakeProject.ErrorMessage"), "ErrorMessage")(p);
                memo[tuple(`ErrorMessage`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree ErrorMessage(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(FunctionArgumentList, "QMakeProject.ErrorMessage")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(FunctionArgumentList, "QMakeProject.ErrorMessage"), "ErrorMessage")(TParseTree("", false,[], s));
        }
    }
    static string ErrorMessage(GetName g)
    {
        return "QMakeProject.ErrorMessage";
    }
